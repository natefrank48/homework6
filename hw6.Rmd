...
The above graph shows the relationship between happiness level and financial status. We can see that people that has a financial status far above average actually are the least happy compare to the others, on the other hand, those whose financial relationship are far below average are the happiest among others. Therefore we can conclude that having more money does not mean one has a high happiness level.
